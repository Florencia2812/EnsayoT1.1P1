...
namespace admRegistro.Controllers
{
    public class RegistroesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RamirezID,FriendofRamirez,Place,Email,Birthdate")] Registro registro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RamirezID,FriendofRamirez,Place,Email,Birthdate")] Registro registro)
        {
            if (ModelState.IsValid)
            {
